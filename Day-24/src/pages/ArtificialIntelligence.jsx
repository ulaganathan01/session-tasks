export default function ArtificialIntelligence(){
    const data = [
        {
            courseName: "Artificial Intelligence and Machine Learning Course",
            languages: ["ENGLISH", "TAMIL"],
            image: "https://static.guvi.in/blog/zenThumbnailNew/ai-ml.webp"
        }
    ]
    return(
        <div className="row m-2">
            <h4 className="border-bottom border-secondary pb-2">Artificial Intelligence and Machine Learning Courses</h4>
        {
